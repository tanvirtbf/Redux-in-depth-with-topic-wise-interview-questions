...
function reducer(state = initialState, action) {
    ...
    switch(action.type){
        case INCREMENT:
            newState = {
                ...newState,
                post: newState.post + action.payload
            };
            break;
        case DECREMENT:
            newState = {
        ...
        case INCREASEBY:
            newState = {
                ...newState,
                post: newState.post + action.payload.amount
            };
            break;
        case DECREASEBY:
            newState = {
...
const { dispatch, getState, subscribe } = (0, _redux.createStore)(reducer, window.__REDUX_DEVTOOLS_EXTENSION__?.());
dispatch(actionObj(INCREMENT, 3));
dispatch(actionObj(INCREMENT, 4));
dispatch(actionObj(DECREMENT, 2));
dispatch(actionObj(DECREMENT, 1));
dispatch(actionObj(DECREMENT, 2));
dispatch(actionObj(INCREASEBY, {
    amount: 5
}));
dispatch(actionObj(DECREASEBY, {
    amount: 4
}));
subscribe(()=>{
